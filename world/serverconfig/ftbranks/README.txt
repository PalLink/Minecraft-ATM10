...
Last README file update: Thu May 28 01:32:20 CEST 2026
...
command.addmaxmahou
command.addmaxmahou.player
command.addmaxmahou.player.mana
...
command.clearfictions
command.clearplayerfictions
command.clone
command.clone.begin
...
command.dismiss_announcements
command.dismiss_announcements.input
...
command.ironsSpellbooks.config.convert_legacy_config
...
command.undergarden
command.undergarden.infection
command.undergarden.infection.targets
command.undergarden.infection.targets.set
command.undergarden.infection.targets.set.amount
command.unmute
